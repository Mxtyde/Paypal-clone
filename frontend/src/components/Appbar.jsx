...
import logo from "../images/logo.png"; // Correctly import the image
    ...
    <div className="shadow h-14 flex justify-between items-center md:px-10">
      <Link to={"/dashboard"}>
        <div className="flex flex-col justify-center h-full ml-4 font-bold">
          <img src={logo} alt="Logo" className="h-10" /> {/* Use the imported logo */}
        </div>
      </Link>
      <div className="flex items-center justify-center gap-2">
        <Button label={"Sign Out"} onClick={signOutHandler} />
        <div className="rounded-full h-10 w-10 p-4  text-white bg-blue-800 flex justify-center mr-2">
